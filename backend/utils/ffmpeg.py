...
# For backward compatibility, expose the static methods as functions
check_ffmpeg_availability = FFmpegManager.check_availability
run_ffmpeg_command = FFmpegManager.run_command
